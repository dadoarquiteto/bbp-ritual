// ==================================================
// CONFIGURAÇÃO DA TIMELINE PARA CENA 6
// ==================================================
const TIMELINE_DATA = {
  currentScene: 6,
  totalScenes: 9,
  ...
  phases: [
    ...
    },
    {
      ...
      seeds: 4385,
      date: "2025-01-05",
      description: "Manifestação do ritual completo. O Blueprint se torna realidade.",
      icon: "milestone",
      color: "#ff4444",
      unlocked: true
    },
...
function initTimeline() {
  console.log('🕐 Inicializando timeline da Cena 6...');
  ...
  console.log('✅ Timeline da Cena 6 inicializada');
}
