// ==================================================
// SISTEMA P2P - CENA 6 (Conectar = Participar)
// ==================================================

// CONFIGURAÇÃO DA CENA
const SCENE_NUMBER = 6;
const TOTAL_SEEDS = 30000;
...
function initGun() {
  ...
  stepCounter.on((value) => {
    ...
    if (currentSeedCount >= TOTAL_SEEDS && !sceneCompleted) {
      sceneCompleted = true;
      console.log('🎉 Cena 6 completada! Ritual concluído! Redirecionando para o Viewer...');
      showNotification('🎉 RITUAL COMPLETO! Redirecionando para o Viewer...', 4000);
      setTimeout(() => {
