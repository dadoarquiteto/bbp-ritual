// ==================================================
// SISTEMA P2P - CENA 2 (Conectar = Participar)
// ==================================================
...
function initGun() {
  ...
  stepCounter.on((value) => {
    ...
    if (currentSeedCount >= TOTAL_SEEDS && !sceneCompleted) {
      sceneCompleted = true;
      console.log('🎉 Cena 2 completada! Redirecionando para Cena 3...');
      showNotification('🎉 Cena 2 concluída! Avançando para a Cena 3...', 3000);
      setTimeout(() => {
