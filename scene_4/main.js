// ==================================================
// CONFIGURAÇÕES DA CENA 4
// ==================================================
let currentFrameNumber = 0;
const totalFrames = 650; // Total de frames da Cena 4
let totalSeeds = 8000; // 8.000 seeds para Cena 4
...
function startEternalRitualLoop() {
  console.log('📜 Ritual da Ressonância eterno iniciado');
  inEternalLoop = true;
  
  if (loreTitle) {
    loreTitle.textContent = 'A RESSONÂNCIA É ETERNA';
  ...
  if (ritualPhase) {
    ritualPhase.textContent = '📜 Cena 4: Ressonância Bem Sucedida';
  }
...
const SCENES = [
  {
    ...
    steps: [
      ...
      { from: 201, to: 209, animation: "getting_scooter", loop: false },
      { from: 210, to: 450, animation: "scooter", loop: true },
      { from: 451, to: 550, animation: "walking", loop: true },
      { from: 551, to: 595, animation: "hand_box", loop: false },
      { from: 596, to: 650, animation: "walking", loop: true }
    ]
  }
];
...
function showRitualOverlay() {
  ...
  console.log('📜 Mostrando overlay da Cena 4');
  overlayShown = true;
  isMoving = false;
...
function startMainLoop() {
  ...
  mainInterval = setInterval(() => {
    try {
      ...
      // ==================================================
      // CONTROLE DA ANIMAÇÃO FLOAT DO BONECO (CENA 4)
      // ==================================================
