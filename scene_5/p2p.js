// ==================================================
// SISTEMA P2P - CENA 5 (Conectar = Participar)
// ==================================================
...
function initGun() {
  ...
  stepCounter.on((value) => {
    ...
    if (currentSeedCount >= TOTAL_SEEDS && !sceneCompleted) {
      sceneCompleted = true;
      console.log('🎉 Cena 5 completada! Redirecionando para Cena 6...');
      showNotification('🎉 Cena 5 concluída! Avançando para a Cena 6...', 3000);
      setTimeout(() => {
