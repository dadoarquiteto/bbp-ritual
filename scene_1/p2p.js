// ==================================================
// SISTEMA P2P - CENA 1 (Conectar = Participar)
// ==================================================
...
function initGun() {
  ...
  stepCounter.on((value) => {
    ...
    if (currentSeedCount >= TOTAL_SEEDS && !sceneCompleted) {
      sceneCompleted = true;
      console.log('🎉 Cena 1 completada! Redirecionando para Cena 2...');
      showNotification('🎉 Cena 1 concluída! Avançando para a Cena 2...', 3000);
      setTimeout(() => {
