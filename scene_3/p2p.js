// ==================================================
// SISTEMA P2P - CENA 3 (Conectar = Participar)
// ==================================================
...
function initGun() {
  ...
  stepCounter.on((value) => {
    ...
    if (currentSeedCount >= TOTAL_SEEDS && !sceneCompleted) {
      sceneCompleted = true;
      console.log('🎉 Cena 3 completada! Redirecionando para Cena 4...');
      showNotification('🎉 Cena 3 concluída! Avançando para a Cena 4...', 3000);
      setTimeout(() => {
