// ==================================================
// BBP NETWORK - CENA 3 (FIREBASE REAL)
// ==================================================

const SCENE_NUMBER = 3;
const TOTAL_SEEDS = 6000;
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Informa ao BBPRitual qual é a cena atual
    if (window.BBPRitual) {
        window.BBPRitual.setCurrentScene(SCENE_NUMBER);
    } else {
        setTimeout(() => {
            if (window.BBPRitual) window.BBPRitual.setCurrentScene(SCENE_NUMBER);
        }, 1000);
    }
